...
제 1 조 (목적)
본 약관은 떠나요닷컴(사이트명)을 통상 "회사"로 규정하고 회사에서 제공하는 인터넷 서비스 및 부가 서비스를 이용하는 사용자(네티즌, 이용회원, 일반고객, 예약자, 펜션주)을 통상 이용자 또는 회원으로 규정하여, "회사"와 "이용자" 또는 "회원간의 의무 와 책임, 서비스 이용시 준수 사항등을 규정한 것입니다.
