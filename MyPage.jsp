...
<form style="margin-top: 10">
 <div class="mTitle"><h3>회원정보</h3></div>
 <table width="100%">
  <colgroup>
   <col width="50%" />
   <col width="2%" />
  ...
  <tr>
   <td>
    <table>
	 ...
	 <tr>
	  <th>아이디</th>
	  <td><span><%=u_id %></span></td>
	 </tr>
	 <tr>
	  <th>이름</th>
	  <td><span><%=uDto.getU_name() %></span></td>
	 </tr>
	 <tr>
	  <th>Email</th>
	  <td><span><%=uDto.getU_email() %></span></td>
	 </tr>
	 <tr>
	  <th>핸드폰</th>
	  <td><span><%=uDto.getU_cell() %></span></td>
	 </tr>
	</table>
   ...
   <td valign="top">
	<div style="border:solid 10px #eeeeee; height:125px; padding-left:10px;">
	 <div style="font-size:14px; color:orange; margin:10px 0px 0px 0px; font-weight:bold;">나의 현재 적립금</div>
 ...
 <div>	
  <div style="margin:10px 0px 10px 0px; text-align:right;">예약일 
   <span>
