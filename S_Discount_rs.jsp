...
%>
		<img width="150px" height="120px" src="imgs/pension/<%=p_num1%>/<%=p_num2%>_F01.jpg" class="imgshot">
		</td>
		<td rowspan="<%=r_size + 1%>" style="border-left: 0;">
		<label>
			<b><%=p_dto.getP_name()%></b><br>
			<%=p_dto.getP_addr1()%> <%=p_dto.getP_addr2()%><br>
			<a href="DetailView.jsp?p_num=<%=p_num1%>" id="linkshot">미리보기</a>
		</label>
		</td>
	</tr>
<%
...
%>
			<tr>
				<td>
					<%=r_dto.getR_name()%>
					<a href="DetailView.jsp?p_num=<%=r_dto.getR_pension()%>">
					<input type="button" name="ord"	value="예약">
